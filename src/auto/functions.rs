...
pub fn keyboard_grab(window: &Window, owner_events: bool, time_: u32) -> GrabStatus {
    ...
    unsafe {
        ffi::gdk_keyboard_grab(window.to_glib_none().0, owner_events.to_glib(), time_)
    }
}
...
//pub fn pango_layout_line_get_clip_region(line: /*Ignored*/&pango::LayoutLine, x_origin: i32, y_origin: i32, index_ranges: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }, n_ranges: i32) -> /*Ignored*/Option<cairo::Region> {
//    unsafe { TODO: call ffi::gdk_pango_layout_line_get_clip_region() }
//}

//pub fn parse_args(argc: &mut i32, argv: /*Unimplemented*/Vec<String>) {
...
pub fn pointer_grab<'a, 'b, P: Into<Option<&'a Window>>, Q: Into<Option<&'b Cursor>>>(window: &Window, owner_events: bool, event_mask: EventMask, confine_to: P, cursor: Q, time_: u32) -> GrabStatus {
    ...
    unsafe {
        ffi::gdk_pointer_grab(window.to_glib_none().0, owner_events.to_glib(), event_mask, confine_to.0, cursor.0, time_)
    }
}
...
//pub fn property_get(window: &Window, property: &Atom, type_: &Atom, offset: libc::c_ulong, length: libc::c_ulong, pdelete: i32, data: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }) -> Option<(Atom, i32, i32)> {
//    unsafe { TODO: call ffi::gdk_property_get() }
//}

//pub fn query_depths(depths: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 14 }) -> i32 {
//    unsafe { TODO: call ffi::gdk_query_depths() }
//}

//pub fn query_visual_types(visual_types: /*Unimplemented*/CArray TypeId { ns_id: 1, id: 100 }) -> i32 {
...
pub fn synthesize_window_state(window: &Window, unset_flags: WindowState, set_flags: WindowState) {
    skip_assert_initialized!();
    unsafe {
        ffi::gdk_synthesize_window_state(window.to_glib_none().0, unset_flags, set_flags);
    }
}
...
pub fn test_simulate_button(window: &Window, x: i32, y: i32, button: u32, modifiers: ModifierType, button_pressrelease: EventType) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(ffi::gdk_test_simulate_button(window.to_glib_none().0, x, y, button, modifiers, button_pressrelease))
    }
}
...
pub fn test_simulate_key(window: &Window, x: i32, y: i32, keyval: u32, modifiers: ModifierType, key_pressrelease: EventType) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(ffi::gdk_test_simulate_key(window.to_glib_none().0, x, y, keyval, modifiers, key_pressrelease))
    }
}

//pub fn text_property_to_utf8_list_for_display(display: &Display, encoding: &Atom, format: i32, text: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, length: i32, list: /*Unimplemented*/Vec<String>) -> i32 {
//    unsafe { TODO: call ffi::gdk_text_property_to_utf8_list_for_display() }
//}
