...
impl Visual {
    ...
    pub fn get_best_with_both(depth: i32, visual_type: VisualType) -> Option<Visual> {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::gdk_visual_get_best_with_both(depth, visual_type))
        }
    }
    ...
    pub fn get_best_with_type(visual_type: VisualType) -> Option<Visual> {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::gdk_visual_get_best_with_type(visual_type))
        }
    }
...
impl<O: IsA<Visual>> VisualExt for O {
    ...
    fn get_byte_order(&self) -> ByteOrder {
        unsafe {
            ffi::gdk_visual_get_byte_order(self.to_glib_none().0)
        }
    }
    ...
    fn get_visual_type(&self) -> VisualType {
        unsafe {
            ffi::gdk_visual_get_visual_type(self.to_glib_none().0)
        }
    }
}
